...
:nnoremap <leader>sv :tabnew $MYVIMRC<cr>
:nnoremap <C-j> <C-W>j<C-W>_
:nnoremap <C-k> <C-W>k<C-W>_
" set window minumum hieght
set wmh=0
...
autocmd BufRead,BufNewFile *.txt,*.ad,*.adoc,*.asciidoc,README,TODO,CHANGELOG,NOTES,ABOUT
